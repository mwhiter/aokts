...
const char extSave[] =
"AOK Scenarios (*.scn)\0*.scn\0AOC 1.0C Scenarios (*.scx)\0*.scx\0AOC 1.4RC Scenarios (*.scx)\0*.scx\0AOHD 3.9 Scenarios (*.scx)\0*.scx\0AOF 3.9 Scenarios (*.scx2)\0*.scx2\0SWGB Scenarios (*.scx)\0*.scx\0Clone Campaigns Scenarios (*.sc1)\0*.sc1\0AOHD 4 (*.scx)\0*.scx\0AOF 4 (*.scx2)\0*.scx2\0AOHD1.26 BETA (*.scx)\0*.scx\0AOF1.26 BETA (*.scx2)\0*.scx2\0All files (*.*)\0*.*\0";
